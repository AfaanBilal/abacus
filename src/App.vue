...
<template>
    <div class="flex justify-center">
        <div class="flex flex-col p-4 m-4 border rounded">
            ...
            <div class="flex gap-4 p-2 border-b-2">
                <div v-for="i in 13" class="flex flex-col gap-2">
                    <div class="w-16 h-16 rounded-2xl" @click="moveTopSpot(i - 1)"
                        :class="{ 'bg-red-900': !emptySpots[i - 1].top, 'bg-gray-300': emptySpots[i - 1].top }">
                    </div>
                    <div class="w-16 h-16 rounded-2xl" @click="moveTopSpot(i - 1)"
                        :class="{ 'bg-red-900': emptySpots[i - 1].top, 'bg-gray-300': !emptySpots[i - 1].top }">
                    </div>
            ...
            <div class="flex gap-4 p-2">
                <div v-for="i in 13" class="flex flex-col gap-2">
                    <div class="w-16 h-16 rounded-2xl" @click="moveSpot(i - 1, 0)"
                        :class="{ 'bg-red-900': emptySpots[i - 1].bottom !== 0, 'bg-gray-300': emptySpots[i - 1].bottom === 0 }">
                    </div>
                    <div class="w-16 h-16 rounded-2xl" @click="moveSpot(i - 1, 1)"
                        :class="{ 'bg-red-900': emptySpots[i - 1].bottom !== 1, 'bg-gray-300': emptySpots[i - 1].bottom === 1 }">
                    </div>
                    <div class="w-16 h-16 rounded-2xl" @click="moveSpot(i - 1, 2)"
                        :class="{ 'bg-red-900': emptySpots[i - 1].bottom !== 2, 'bg-gray-300': emptySpots[i - 1].bottom === 2 }">
                    </div>
                    <div class="w-16 h-16 rounded-2xl" @click="moveSpot(i - 1, 3)"
                        :class="{ 'bg-red-900': emptySpots[i - 1].bottom !== 3, 'bg-gray-300': emptySpots[i - 1].bottom === 3 }">
                    </div>
                    <div class="w-16 h-16 rounded-2xl" @click="moveSpot(i - 1, 4)"
                        :class="{ 'bg-red-900': emptySpots[i - 1].bottom !== 4, 'bg-gray-300': emptySpots[i - 1].bottom === 4 }">
                    </div>
                </div>
            </div>
        </div>
